...
This code of conduct applies to all spaces managed by the Reaction Commerce project. This includes Gitter, the mailing lists, the issue tracker, Reaction events, and any other forums created by the project team which the community uses for communication. In addition, violations of this code outside these spaces may affect a person's ability to participate within them.

If you believe someone is violating the code of conduct, we ask that you report it by emailing [conduct@reactioncommerce.com](mailto:conduct@reactioncommerce.com). For more details please see our Reporting Guidelines.
