...
Translations are loaded into the _Assets_ and _Translations_ collections only once. They can be re-imported via the Internationalization admin panel and the refresh button. More information can be found under [Localization and i18n](/admin/dashboard/localization-and-i18n.md#reloading-translations).
