...
import { getComponent as assertComponent, registerComponent } from "@reactioncommerce/reaction-components";
...
**Note**: If you just want to override the homepage and leave everything else alone, you can do that by adding special INDEX_OPTIONS parameters to this `defaults.js` file. See the ["How to create a custom homepage"](/developer/how-to-create-a-custom-homepage.md) documentation for more info.
